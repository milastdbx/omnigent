...
BUILTIN_ENTITIES: tuple[Entity, ...] = (
    ...
    Entity(
        ...
        backing_prompt="Use the GitHub MCP to create a PR with the current credentials.",
        group_id="grp_builtin_github",
    ),
    Entity(
        id="ent_builtin_github_request_review",
        created_at=0,
        updated_at=0,
        title="Request review",
        instruction="Request a review on the GitHub pull request from the appropriate reviewers.",
        backing_prompt="Use the GitHub MCP to request reviewers on the pull request with the current credentials.",
        group_id="grp_builtin_github",
    ),
    Entity(
        id="ent_builtin_github_address_review_comments",
        created_at=0,
        updated_at=0,
